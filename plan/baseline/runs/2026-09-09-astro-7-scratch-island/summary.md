# Baseline: astro-7-scratch-island

- base: http://localhost:8798
- captured: 2026-09-09T20:59:50.460Z
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| /2026 | 200 | 15.2 | 0 | 4 | 0.0 | 17.1 | 1023.2 | 1 | 0 | 0/0/0/0 |
...
- /2026: 0 script(s)
- /2026/CHA: 3 script(s)
  - http://localhost:8798/_astro/team-season-pace.astro_astro_type_script_index_0_lang.Bg2par1W.js
  - http://localhost:8798/_astro/utils.DS64JlTE.js
  - http://localhost:8798/_astro/echarts.BzgXyCAX.js
...
- /2026: 200 3095B  cache-control: `-`  cf-cache-status: -  age: -
- /2026/CHA: 200 3519B  cache-control: `-`  cf-cache-status: -  age: -
