...
- captured: 2026-09-09T15:36:20.382Z
...
- /archive: 0 script(s)
- /stats: 5 script(s)
  - http://localhost:8790/_astro/surprises-per-season.astro_astro_type_script_index_0_lang.DhJcg8XD.js
  - http://localhost:8790/_astro/surprises-by-team.astro_astro_type_script_index_0_lang.Cj6O5lLI.js
  - http://localhost:8790/_astro/team-season-scatter.astro_astro_type_script_index_0_lang.DDCBT9c8.js
  - http://localhost:8790/_astro/echarts.Bl8Wgh64.js
  - http://localhost:8790/_astro/utils.Blt5UFT-.js
- /about: 0 script(s)
- /2025: 0 script(s)
- /2025/CHA: 3 script(s)
  - http://localhost:8790/_astro/team-season-pace.astro_astro_type_script_index_0_lang.CuDZwX8g.js
  - http://localhost:8790/_astro/utils.Blt5UFT-.js
  - http://localhost:8790/_astro/echarts.Bl8Wgh64.js
- /2024: 0 script(s)
- /2024/TOR: 3 script(s)
